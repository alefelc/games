...
export default function App() {
  ...
  const closeAccountView = () => {
    ...
    if (readCoupleCodeFromLocation()) clearCoupleCodeFromLocation();
  };

  if (authStatus === "initializing") {
    return <LoadingScreen content={content} message="Verificando tu sesión…" />;
  }
    ...
    return (
      <AuthScreen
        ...
        onAuthenticated={() => {
          ...
          setAccountView(initialCoupleCode ? "profile" : "none");
        }}
      />
    );
  }
