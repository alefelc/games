...
describe("inventario y variedad R20", () => {
  it("publica el catálogo curado y relaciones reales para cada opción visible", () => {
    expect(rootBundle.cards).toHaveLength(894);
    expect(rootBundle.cardElements.length).toBeGreaterThanOrEqual(130);
    expect(rootBundle.cardToys.length).toBeGreaterThanOrEqual(168);
