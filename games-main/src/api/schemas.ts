...
export const cardSchema = z.object({
  ...
  card_kind: z.enum(["question", "preparation", "action", "transition", "continuity", "climax", "closure"]).optional().default("action"),
  scene_phase_min: z.enum(["connection", "provocation", "contact", "nudity", "action", "intensification", "climax", "closure"]).optional().default("connection"),
  scene_phase_max: z.enum(["connection", "provocation", "contact", "nudity", "action", "intensification", "climax", "closure"]).optional().default("closure"),
  scene_phase_after: z.enum(["connection", "provocation", "contact", "nudity", "action", "intensification", "climax", "closure"]).optional().default("connection"),
  physical_state_min: z.enum(["clothed", "suggestive", "partial_nudity", "nude", "sexual_activity", "climax", "aftercare"]).optional().default("clothed"),
  physical_state_after: z.enum(["clothed", "suggestive", "partial_nudity", "nude", "sexual_activity", "climax", "aftercare"]).optional().default("clothed"),
  activity_family: nullableString,
  activity_action: z.enum(["none", "start", "continue", "intensify", "switch", "complete"]).optional().default("none"),
  requires_previous_activity: nullableString,
  forbidden_after_activity: nullableString,
  allow_activity_change: bool.optional().default(true),
  allow_position_change: bool.optional().default(true),
  allow_rhythm_change: bool.optional().default(true),
  inventory_action: z.enum(["none", "introduce", "prepare", "use", "continue", "replace", "remove"]).optional().default("none"),
  estimated_duration_seconds: number.optional().default(0),
  variant_group: nullableString,
  cooldown_sessions: number.optional().default(2),
});
