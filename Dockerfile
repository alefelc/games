...
COPY games-main/src ./games-main/src
COPY games-main/public ./games-main/public
...
COPY games-main/deploy/security-headers.conf /etc/nginx/security-headers.conf
