...
ARG BUILD_RELEASE=2.11.2-ai-stability
...
RUN echo "Building release $BUILD_RELEASE with adaptive retries and same-origin proxy" \
    && npm run build \
...
LABEL org.opencontainers.image.version="2.11.2-ai-stability"
