...
export function AgeGate({
  ...
  return (
    <main className="center-screen age-screen">
      ...
      <p className="lead">
        Este juego contiene lenguaje y propuestas sexuales explícitas. No está
      ...
      <div className="consent-box">
        <label className="check-row">
          ...
          />
          <span>
            <b>Tengo {minimumAge} años o más</b>
            <small>
              Confirmo que puedo acceder legalmente a contenido para adultos.
            </small>
          </span>
        </label>
        <label className="check-row">
          ...
          />
          <span>
            <b>Entiendo la regla central</b>
            <small>
              Cualquier carta puede saltarse. “{content.settings.stop_word}”
      ...
      <div className="privacy-inline">
        <Icon name="lock" />
        <span>
          No se guardan respuestas, fotos ni videos fuera de este dispositivo.
        </span>
      </div>
    </main>
  );
